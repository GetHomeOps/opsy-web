...
CREATE TABLE pre_purchase_analyses (
    id SERIAL PRIMARY KEY,
    account_id INTEGER NOT NULL REFERENCES accounts(id) ON DELETE CASCADE,
    property_id INTEGER REFERENCES properties(id) ON DELETE SET NULL,
    created_by INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
CREATE INDEX idx_pre_purchase_analyses_account ON pre_purchase_analyses(account_id);
CREATE INDEX idx_pre_purchase_analyses_property ON pre_purchase_analyses(property_id);
CREATE INDEX idx_pre_purchase_analyses_status ON pre_purchase_analyses(status);
CREATE INDEX idx_pre_purchase_analyses_created ON pre_purchase_analyses(created_at DESC);
CREATE INDEX idx_pre_purchase_analyses_created_by ON pre_purchase_analyses(created_by);

CREATE TABLE pre_purchase_documents (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX idx_pre_purchase_documents_analysis ON pre_purchase_documents(analysis_id);

CREATE TABLE pre_purchase_systems (
    id SERIAL PRIMARY KEY,
    analysis_id INTEGER NOT NULL REFERENCES pre_purchase_analyses(id) ON DELETE CASCADE,
    system_key VARCHAR(50) NOT NULL,
...
CREATE INDEX idx_pre_purchase_systems_analysis ON pre_purchase_systems(analysis_id);
CREATE UNIQUE INDEX idx_pre_purchase_systems_key ON pre_purchase_systems(analysis_id, system_key);

CREATE TABLE pre_purchase_findings (
    id SERIAL PRIMARY KEY,
    analysis_id INTEGER NOT NULL REFERENCES pre_purchase_analyses(id) ON DELETE CASCADE,
...
CREATE INDEX idx_pre_purchase_findings_analysis ON pre_purchase_findings(analysis_id);
CREATE INDEX idx_pre_purchase_findings_severity ON pre_purchase_findings(analysis_id, severity);
CREATE INDEX idx_pre_purchase_findings_system ON pre_purchase_findings(system_id);

CREATE TABLE pre_purchase_recommendations (
    id SERIAL PRIMARY KEY,
    analysis_id INTEGER NOT NULL REFERENCES pre_purchase_analyses(id) ON DELETE CASCADE,
...
CREATE INDEX idx_pre_purchase_recommendations_analysis ON pre_purchase_recommendations(analysis_id);
CREATE INDEX idx_pre_purchase_recommendations_urgency ON pre_purchase_recommendations(analysis_id, urgency_group);

CREATE TABLE pre_purchase_professional_matches (
    id SERIAL PRIMARY KEY,
    analysis_id INTEGER NOT NULL REFERENCES pre_purchase_analyses(id) ON DELETE CASCADE,
