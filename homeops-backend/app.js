...
const bulkOnboardRoutes = require("./routes/bulkOnboard");
...
const bidReviewsRoutes = require("./routes/bidReviews");
const prePurchaseRoutes = require("./routes/prePurchase");
...
app.use("/properties/bulk-onboard", bulkOnboardRoutes);
...
app.use("/pre-purchase", prePurchaseRoutes);
app.use("/", inspectionChecklistRoutes);
app.use("/", bidReviewsRoutes);
app.use("/ai", aiRoutes);
