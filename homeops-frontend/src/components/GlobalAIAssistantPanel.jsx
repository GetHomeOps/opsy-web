  ...
  return (
    <>
      ...
      <Transition
        show={isOpen}
        tag="div"
        className="fixed inset-y-0 right-0 z-50 w-full max-w-md h-[100dvh] bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 shadow-xl flex flex-col overflow-hidden"
                  ...
                  <div className="flex flex-col items-center justify-center py-8 text-center">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="rounded-full px-4 py-2 text-sm font-medium btn-primary dark:bg-teal-600 dark:hover:bg-teal-500"
                      >
                        Upgrade plan
                      </button>
                    </div>
