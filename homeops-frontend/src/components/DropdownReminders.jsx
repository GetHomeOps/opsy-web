      ...
      >
        ...
        >
          ...
          <Link
            ...
            onClick={() => setDropdownOpen(false)}
            className={`w-full flex items-center justify-center gap-1.5 py-2.5 text-sm font-medium rounded-lg transition-colors no-underline ${ hasCalendarConnected ? "btn-primary dark:bg-[#456564] dark:hover:bg-[#3a5554]" : "bg-[#C76C4B] hover:opacity-90" }`}
          >
