...
function ContractorDropdown({
  ...
  const linkedContact = useMemo(
    () =>
      findContactForContractor(
        {contractor: value, contractorEmail},
        [...(favoriteProfessionals || []), ...(contacts || [])],
      ),
    [value, contractorEmail, favoriteProfessionals, contacts],
  );
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      {linkedContact?.id != null && (
        <ContactLinkIcon contactId={linkedContact.id} />
      )}
    </div>
  );
}
