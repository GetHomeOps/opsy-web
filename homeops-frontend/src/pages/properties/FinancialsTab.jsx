...
import {
  ...
  formatCurrency,
  formatShortCurrency,
} from "./partials/financials/financialsDemoData";
...
function FinancialsTab({propertyData = {}, onNavigateTab}) {
  ...
  return (
    <div className="relative">
      <div
        className="blur-[2px] saturate-[0.85] opacity-90 pointer-events-none select-none [mask-image:linear-gradient(to_bottom,#000_0%,#000_38%,transparent_88%)] [-webkit-mask-image:linear-gradient(to_bottom,#000_0%,#000_38%,transparent_88%)]"
        aria-hidden="true"
      >
          ...
          <div className="space-y-4 min-w-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
              <FinancialKpiCard
                ...
                changeTone="positive"
                sparkline={[
                  1095, 1102, 1110, 1125, 1140, 1155, 1162, 1170, 1180,
                ]}
              />
              <FinancialKpiCard
                icon={Banknote}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
              ...
              <SectionCard
                flat
                title="Linked Financial Records"
                icon={FileText}
              >
                <ul className="divide-y divide-neutral-100 dark:divide-neutral-800">
            ...
            <SectionCard flat title="Ownership & Financing" icon={Landmark}>
              <div className="space-y-2.5">
                <LabelValue
                  ...
                  value={data.ownership.status}
                />
                <LabelValue
                  label="Occupancy"
                  value={data.ownership.occupancy}
                />
              ...
              <div className="flex items-start gap-2 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-600 dark:text-neutral-300 mt-1 leading-relaxed">
                    Based on current rates, refinancing could save you
                    approximately{" "}
