            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-4">
              ...
              <div className="mb-4 sm:mb-0 mr-2">
                <ul className="flex flex-wrap items-center -m-1">
                  ...
                  <li className="m-1">
                    <button className="btn-sm bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-violet-500">
                      +Add New
                    </button>
                  </li>
                </ul>
              ...
              <div className="flex flex-nowrap -space-x-px">
                ...
                <button className="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:bg-gray-50 dark:hover:bg-gray-900 text-gray-600 dark:text-gray-300 rounded-none first:rounded-l-lg last:rounded-r-lg">
                  Week
                </button>
                <button className="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:bg-gray-50 dark:hover:bg-gray-900 text-gray-600 dark:text-gray-300 rounded-none first:rounded-l-lg last:rounded-r-lg">
                  Day
                        ...
                        <div className="grow flex flex-col relative p-0.5 sm:p-1.5 overflow-hidden">
                          {getEvents(day).map((event) => {
                            return (
                              ...
                              >
                                <div
                                  className={`px-2 py-0.5 rounded-lg overflow-hidden ${eventColor(event.eventColor)}`}
                                >
                                  {/* Event name */}
                          ...
                          <div
                            className="absolute bottom-0 left-0 right-0 h-4 bg-linear-to-t from-white dark:from-gray-800 to-transparent pointer-events-none"
                            aria-hidden="true"
                          ></div>
                        </div>
                        {/* Cell footer */}
